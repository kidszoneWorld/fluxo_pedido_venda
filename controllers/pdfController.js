...
exports.sendPdf = async (req, res) => {
    ...
    try {
        ...
        await transporter.sendMail({
            from: 'Pedidos Kids Zone <pedidos.kidszoneworld@gmail.com>', // Seu e-mail do Gmail
            to: ['pedidoskz@kidszoneworld.com.br','ti.kz@kidszoneworld.com.br','comercial.kz@kidszoneworld.com.br',emailRep], // Destinatário do e-mail
